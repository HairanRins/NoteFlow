...
return [
    ...
    'title' => 'NoteFlow API Documentation',
    ...
    'base_url' => env('APP_URL', 'https://noteflow-orqw.onrender.com'),
    ...
    'routes' => [
        [
            'match' => [
                ...
                'prefixes' => ['api/*', 'login', 'register', 'logout', 'forgot-password', 'reset-password', 'profile', 'email/*', 'verify-email*'],
    ...
    'strategies' => [
        ...
        'responses' => [
            // Disabled response calls to avoid auth errors during doc generation
            // Use @apiResource, @response, or manual annotations instead
        ],
        'responseFields' => [
